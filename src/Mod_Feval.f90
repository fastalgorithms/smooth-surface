...
!!! DESCRIPTION:
!!!
!!! This module contains functions and data types to allow the evaluation of the function F
!!! Notice that we have already substracted 0.5d0, therefore Newton has to find the zero set F(x,y,z) = 0.0d0
!!!
!!! INDEX OF SUBROUTINES AND FUNCTIONS:
!!!
!!! Public:
!!!
!!!  1-start_Feval                          !! generate all the data structure required to evaluate F
!!!                                         !! including the trees for the FMM and sgma generator
!!!  2-eval_density_grad_FMM                !! function that evaluates F and gradient at arbitrary points in space.
!!!
!!! Private: (none)
!!!
...
!!! Public:
!!!
!!! 1-Feval_stuff   !! All the information required to evaluate F, includin Manas' trees, and the the tree required
!!!                  to evaluate sigma
!!!
!!! Private: (none)
!!!
