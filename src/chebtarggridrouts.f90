...
end subroutine precompphi_fun1 
!-------------------------------------------     
...
subroutine newtargeval(targets,stdev,stdev_grad,ibox,ilev,nboxes, &
...
!        call prin2('dipvecsort=*',dipvecsort,3*ns)
!        call prin2('targets=*',targets,3)
!        call prin2('stdev=*',stdev,1)
!        call prin2('stdev_grad=*',stdev_grad,3)
!
!        call prinf('itstart=*',itstart,1)
!        call prinf('itend=*',itend,1)
